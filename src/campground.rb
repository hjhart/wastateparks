...
class Campground < Kimurai::Base
  ...
  def parse(response, url:, data: {})
    ...
    campgrounds_too_far_away = ["Camano Island​", "Kitsap Memorial​", "Larrabee​", "South Whidbey​", "Twanoh", "Deception Pass", "Retreat Center - Cornet Bay​", "Potlatch​", "Rasar​", "Fort Ebey​", "Schafer", "Rockport​", "Birch Bay", "Fort Townsend", "Lake Wenatchee​", "Peace Arch", "Sequim Bay​", "Retreat Center - Ramblewood​", "Fort Casey​", "Fort Worden​", "Dosewallups", "Ocean City​", "Retreat Center - Fort Flagler​", "Jarrel Cove", "Pacific Beach​", "Spencer Spit​", "Griffiths-Priday​", "Jones Island​", "Moran​", "Retreat Center - Camp Moran​", "Bogachiel", "Sucia Island​", "Posey Island​", "Blake Island"]
